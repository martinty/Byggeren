...
uint8_t MPC2515_init();
void MCP2515_reset();
void MPC2515_requestToSend(uint8_t reg);
uint8_t MCP2515_readStatus();
void MPC2515_bitModify(uint8_t addr, uint8_t mask, uint8_t data);
...
#define MCP_RTS			0x80
#define MCP_RTS_TX0		1
#define MCP_RTS_TX1		2
#define MCP_RTS_TX2		4
#define MCP_RTS_ALL		7
